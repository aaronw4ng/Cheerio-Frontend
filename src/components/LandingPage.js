    ...
    >
      <Content>
        ...
        <Image
          ...
          style={{ marginTop: 10, marginBottom: 20, marginLeft: 120 }}
        />
        ...
        <View style={styles.button}>
          ...
          <Text style={{ textAlign: 'center', marginTop: 10 }}>Emotions Learned</Text>
        </View>
        <View>
          <Image
            style={{ marginTop: 30 }}
            source={require('../../assets/images/landingPageBottom.png')}
          />
          <TouchableOpacity
            style={{
              position: 'absolute',
      ...
      >
        <TouchableOpacity>
          <Image source={require('../../assets/images/navbar/home-nav-active.png')} />
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => {
            Actions.Question1();
