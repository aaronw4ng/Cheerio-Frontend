...
const Question6 = () => (
  <Container>
    <Content padder>
      ...
      />
      <Spacer size={25} />
      <H2 style={styles.H2Style}>Is this feeling stemming more from injustice or unexpectedness?</H2>
      <Spacer size={100} />
      <GallerySwiper
        style={{
          height: 300,
      ...
      />
      <Spacer size={100} />
      <AppButton onPress={() => alert("question 6 pressed")} title="Next Question" />
    </Content>
  </Container>
);
