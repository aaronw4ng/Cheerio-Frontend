...
const Question3 = () => (
  <Container>
    <Content padder>
      ...
      />
      <Spacer size={25} />
      <H2 style={styles.H2Style}>When you look at the person do you feel pain or annoyance?</H2>
      <Spacer size={100} />
      <TouchableOpacity>
          <Text style={styles.button}>Pain</Text>
      </TouchableOpacity>
      <Spacer size={25} />
      <TouchableOpacity>
          <Text style={styles.button}>Annoyance</Text>
      </TouchableOpacity>
      <Spacer size={25} />
      <TouchableOpacity>
